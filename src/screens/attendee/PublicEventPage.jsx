...
import {
  ...
  IdentificationCard, Car, CaretDown,
...
function useVenueCoords(address) {
...
function LocationCard({ venue, city, country }) {
      ...
      <div className={`max-w-[1100px] mx-auto ${isDesk ? "px-10 pt-7 pb-14" : "px-4 pt-4 pb-10"}`}>
        ...
        <div className={`flex gap-10 items-start ${isDesk ? "flex-row" : "flex-col"}`}>
          ...
          <div className="flex-1 min-w-0 w-full">
            ...
            <LocationCard venue={event.venue} city={event.city} country={event.country} />
