...
function ForgotPassword({ onBack }) {
  ...
  return (
    <div style={{ minHeight: "100%", background: "#f8f8f6", padding: "60px 28px 40px" }}>
      <button onClick={onBack} style={{ background: "none", border: "none", cursor: "pointer", color: "#f5a623", fontSize: "16px", marginBottom: "24px", display: "flex", alignItems: "center", gap: "6px", padding: 0, fontWeight: 600 }}>
        ← Back
      </button>

      <div style={{ textAlign: "center", marginBottom: "32px" }}>
        <div style={{ width: "64px", height: "64px", borderRadius: "18px", background: "linear-gradient(135deg, #f5a623, #e8920f)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "30px", margin: "0 auto 16px", boxShadow: "0 8px 24px rgba(245,166,35,0.3)" }}>🔐</div>
        <h1 style={{ color: "#1a1a1a", fontSize: "24px", fontWeight: 800, marginBottom: "8px" }}>Forgot Password?</h1>
        <p style={{ color: "#aaa", fontSize: "14px", lineHeight: 1.5 }}>Enter your email and we'll send you a reset link</p>
      </div>
    ...
    <div style={{ minHeight: "100%", background: "#f8f8f6", padding: "60px 28px 40px", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ marginBottom: "4px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
          ...
          <div onClick={() => setShowForgot(true)} style={{ fontSize: "13px", color: "#f5a623", fontWeight: 600, cursor: "pointer" }}>
            Forgot password?
          </div>
        </div>
        <input
      ...
      <button onClick={onLogin} disabled={loading}
        style={{ ...btnStyle, opacity: loading ? 0.7 : 1, marginTop: "8px" }}>
      ...
      <p style={{ color: "#bbb", fontSize: "12px", marginTop: "10px", textAlign: "center" }}>
        Door staff?{" "}
        <span onClick={() => setScreen("doorStaffLogin")} style={{ color: "#6b6b6b", fontWeight: 600, cursor: "pointer" }}>
